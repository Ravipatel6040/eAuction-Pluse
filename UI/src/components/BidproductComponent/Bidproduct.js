...
<h1 class="mb-4"style={{ color: "#15b9d9" }}>Bid Product Here !</h1>
            ...
            <tr>
                ...
                <td>
                    <form>
                        ...
                        <br/>
                        <button onClick={handleSubmit} type="button" class="btn btn-success">Bid Product</button>
                    </form>
                </td>
            </tr>
        </tbody>
